...
const pesas = [
  ...
  },
  {
    ...
    nivel: "DESCUBRIR",
    titulo: "YO SOLO",
    capacidad: "Cuidado y autonomía corporal",
    descripcion:
      "Baño, ropa, higiene y ayuda adulta. Entrena cómo acompañar la autonomía sin enseñar que toda ayuda corporal es mala ni que cualquier adulto puede intervenir sin explicación.",
    aprendizaje: "Mi cuerpo es mío y a veces necesito ayuda para cuidarlo.",
  ...
  },
  {
    ...
    kg: "5 → 10 KG",
    nivel: "RECONOCER",
    titulo: "¿PUEDO ESTAR DESNUDO?",
    capacidad: "Intimidad y contexto",
    descripcion:
      "Entrena cómo explicar que el cuerpo no es vergonzoso y, al mismo tiempo, que hay momentos y lugares en los que cuidamos nuestra intimidad.",
  ...
  },
  {
    ...
    descripcion:
      "Entrena una diferencia fundamental: tener curiosidad por el cuerpo de otra persona no da derecho a verlo, tocarlo ni pedir que lo enseñe.",
    aprendizaje: "Curiosidad no significa permiso.",
  ...
  },
  {
    ...
    kg: "10 KG",
    nivel: "COMBINAR",
    titulo: "NO SE LO DIGAS A MAMÁ",
    capacidad: "Secretos y pedir ayuda",
    descripcion:
      "Introduce un criterio sencillo para reconocer cuándo algo que piden guardar necesita ser contado a un adulto de confianza.",
    aprendizaje: "Si algo me preocupa, puedo contarlo.",
  ...
  },
  {
    ...
    kg: "10 KG",
    nivel: "COMBINAR",
    titulo: "¿CÓMO HA ENTRADO EL BEBÉ EN LA BARRIGA?",
  ...
  },
  {
    ...
    kg: "10 → 20 KG",
    nivel: "COMBINAR",
    titulo: "JUGÁBAMOS A MÉDICOS",
    capacidad: "Curiosidad, límites y contexto",
    descripcion:
      "Entrena al adulto para observar qué ocurrió, escuchar, enseñar límites y reconocer señales que cambian una conversación educativa por una situación de protección.",
    aprendizaje: "Primero comprendo lo ocurrido. Después decido qué necesita.",
  ...
  },
  {
    ...
    kg: "20 KG",
    nivel: "INTEGRAR",
    titulo: "ME DIJO QUE NO LO CONTARA",
    capacidad: "Integración y protección",
    descripcion:
      "Integra cuerpo, intimidad, límites, secretos y petición de ayuda. RR retira apoyos para que distingas cuándo educar, cuándo seguir preguntando y cuándo priorizar protección.",
    aprendizaje: "No todo se resuelve explicando. A veces toca proteger.",
